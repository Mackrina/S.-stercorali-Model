...
# [S_C, E_C, I_C, S_A, E_A, I_A, S_D, E_DA, I_DA, L_A]
# ---------------------------
IC = {
    ...
    "E_DA": {"name": "constant", "args": {"value": 0}},     # Exposed Dogs (Lineage B)
    "I_DA": {"name": "constant", "args": {"value": 0}},     # Infectious Dogs (Lineage B)
