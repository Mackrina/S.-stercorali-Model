...
# Load CSV file
df = pd.read_csv('final_derivatives_results_NZ') # upload model outputs
...
prevalence_I_DA_range = (0.16, 0.43) #95% CI of prevalence in dogs
...
df_filtered = df[
    ...
    (df['final_prevalence_I_DA'] >= prevalence_I_DA_range[0]) &
    (df['final_prevalence_I_DA'] <= prevalence_I_DA_range[1])
]
# Compute I_D/I_C ratio
df_filtered[ 'ratio'] = df_filtered['final_prevalence_I_DA'] / df_filtered['final_prevalence_I_C']
