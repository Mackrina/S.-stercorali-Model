...
prevalence_I_DA_80_range =  (0.117,0.366)
prevalence_I_DB_80_range = (0.0128, 0.168) 
...
filtered_df = df[
    ...
    #(df['final_prevalence_I_DA'] >= prevalence_I_DA_80_range[0]) &
    #(df['final_prevalence_I_DA'] <= prevalence_I_DA_80_range[1]) &
    #(df['final_prevalence_I_DB'] >= prevalence_I_DB_80_range[0]) &
    #(df['final_prevalence_I_DB'] <= prevalence_I_DB_80_range[1])
...
filtered_df.to_csv('Filetred_80.csv', index=False)
